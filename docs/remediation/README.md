...
- **Latest release and resume point:** [B02i/B02j/B02k](handovers/b02i-b02j-b02k-release.md), [sanitized QC](evidence/b02i-b02j-b02k-release.json). #138/#139/#140 merged; adopted metadata signing removed, canonical photo inventory available, web feed ratings projected. SQL and primary application live-verified; broader privacy/native rollout remains explicit.
...
**Next:** P0 AUD-01 supported-client/native rollout and durable legacy rekey/authority cutoff; QC-01 physical rating protection and remaining mobile/API/detail/profile projections (web feed containment is released); AUD-13/15 atomic group and remaining lifecycle commands. AUD-06 public-profile writes/raw names and helper disclosures are repaired; native acceptance remains. QC-07/QC-17 retain Partial statuses for native acceptance/distribution. AUD-10 ai_notes_summary/OCR/scoring, AUD-09 deferred badge facts/history and AUD-19/21 bootstrap/adoption remain Partial. QC-18 unassociated web labels stays B11. AUD-49 is reopened Partial for historical tracked worktree metadata causing CI checkout-cleanup warnings; its watcher acceptance remains valid. #81/#104/#112 stay open. Merge/close permission applied only to the completed session and expires at handoff.

B04d dependency and B05a tooling scopes remain as documented in their [release](handovers/b04d-b05a-release.md): audits zero, no nested agent files in Metro; AUD-08 native acceptance/distribution remains Partial; AUD-49 watcher scope is retained while its Git-index residual is now Partial. Existing QC-05/10/12 remain B11. OPS-01 duplicate hosting, AUD-01 cache revocation and AUD-06/QC-01 public projections remain separate.
