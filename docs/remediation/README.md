...
- **Latest implementation/QC handover:** [B04d mobile dependency contracts](handovers/batch-04d.md), PR #100; merge/release pending.
- **Latest production release:** [B04c released and verified](handovers/b04c-release.md). Implementation: [B04c compatible dependency remediation](handovers/batch-04c.md). Prior production release: [B04a/B04b released and verified](handovers/b04-release.md). Implementation checkpoints: [B04b](handovers/batch-04b.md), [B04a](handovers/batch-04a.md). Previous release: [B03a/B03b released and verified](handovers/b03-release.md). Implementation: [B03b knowledge lifecycle](handovers/batch-03b.md). Predecessor: [B03a knowledge read containment](handovers/batch-03a.md). Prior release: [B02b production rollout](handovers/sql-rollout-b02b.md). Implementation: [B02b2 Storage/share privacy](handovers/batch-02b2.md). Predecessor: [B02b1 photo/group privacy](handovers/batch-02b1.md). Prior release: [B01/B02a SQL deployed](handovers/sql-rollout-b01-b02a.md); earlier [merged](handovers/merged-b01-b02a.md), [merge readiness](handovers/merge-readiness.md), [batch 02a](handovers/batch-02a.md) and [batch 01](handovers/batch-01.md).
...
**B04c compatible dependency remediation is merged and live on cellarsnap.app at `a0a9564` through PR #98.** Primary Vercel deployment `dpl_ETLBU2jPWkBR1DVctLZN1PgCE3VZ` is Ready. Next 16.3.5 and directly declared Sharp 0.35.4, Expo SDK 56 alignment and reviewed transitive patches clear the root audit (13 → 0) and all mobile high/critical entries (29 → 14 moderate). AUD-08 remains Partial for the legacy router decoder, xcode/uuid tooling, and native acceptance/distribution. [Release evidence and resume steps](handovers/b04c-release.md).

The released baseline is 256 passing isolated tests, web/mobile type/lint and Next production build. Expo web/iOS/Android Hermes exports and prerelease desktop/phone/Expo QC passed. Eight production HTTP checks plus live phone login/feed images/filtering, desktop results and sign-out passed; the disposable scan and 48 child rows were removed. Native simulators/emulators remain unavailable; exports are not native acceptance or an app release. QC-10 remains Open for B11, alongside existing public-rating, Maps and navigation/accessibility findings.

**B04d is implemented and QC passed on `bd40acd`, PR #100; merge/release pending.** Both remaining mobile advisory roots are repaired through explicit tested compatibility contracts; root/mobile audits zero. Native acceptance/distribution remains outstanding. [Handover](handovers/batch-04d.md) records 263 tests and desktop/phone/Expo checks, including existing QC-12 blank single-photo cards and QC-10 overflow. Neither UI issue is mixed into the dependency repair.

**Next: B05a nested-worktree tooling boundaries (AUD-49)**, then broader B05 schema/type baseline. OPS-01 duplicate hosting, AUD-01 photo cache revocation/old-client acceptance and AUD-06/QC-01 public projections stay separate.
