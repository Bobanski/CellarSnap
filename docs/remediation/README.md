...
- **Current handover:** [B11i UGC moderation readiness](handovers/b11i-ugc-moderation-readiness.md), [sanitized evidence](evidence/b11i-ugc-moderation-readiness.json), [PR #174](https://github.com/Bobanski/CellarSnap/pull/174). Database-authoritative screening, canonical report intake, durable private evidence, review deadlines, bounded claim/resolve tooling and an SLA alert contract are implemented and locally verified; QC-25 remains Partial until review/merge, OPS-04 rotation, hosted migration/live acceptance, staffed/drilled alerts/inbox and installed-native acceptance. B11h/#173 is merged and primary/static legal/support releases are live-verified. No native runtime is installed. Five Expo patch updates remain. Cluster Wine, LLC enrollment/invitation and company-owned credentials remain the external Apple gate. PR #172 historical retirement is merged but not hosted or run; zero production deletes. Queue **79 / 15 Closed**.

- **Previous implementation handover:** [B04h/B11g iOS submission readiness](handovers/b04h-b11g-ios-submission-readiness.md), [sanitized evidence](evidence/b04h-b11g-ios-submission-readiness.json), [PR #170](https://github.com/Bobanski/CellarSnap/pull/170). The build 3 candidate is on Expo SDK 57/RN 0.86.3 with a generated privacy manifest, unused microphone/Face ID/audio permissions removed and release contracts in CI. Local automated checks, all-platform production-environment export, disposable iOS prebuild, Web/Mobile CI and primary preview pass. This checkpoint preceded merge and hosted archive release.

- **Latest release handover:** [iOS PR merges and web release](handovers/ios-merge-release.md), [sanitized evidence](evidence/ios-merge-release.json). #167/#168/#165 merged at `1427ebd`/`6f69d83`/`2205a5c`; combined CI and primary preview pass. Production web and Expo browser consent/retry/revocation pass at desktop/phone widths. Owner approved OPS-01 duplicate-check exception. Archive SQL and native Apple submission remain pending; historical queue at that checkpoint **76 / 15 Closed**.
...
- **Historical archive implementation checkpoint:** [B02y / B07b–B09a](handovers/b02y-release-archive.md), [sanitized evidence](evidence/b02y-release-archive-qc.json). #164 merged `421f244`, primary live and desktop/phone cookie/bearer acceptance passed; AUD-11/AUD-28 Closed (**15 Closed / 72**). #165 source `225c0ee` implements protected historical archival copies and durable hash/CAS records; local QC passed, new SQL and hosted copy/access verification pending. AUD-01 remains P0/Partial.
...
**B11i implements the remaining QC-25 code/operations foundation in [PR #174](https://github.com/Bobanski/CellarSnap/pull/174).** Shared post/comment and grouped-card text is filtered in database triggers; reports receive canonical targets, private deletion-resistant evidence and deadlines, including a canonicalized active historical-report backfill; private enforcement prevents authors from restoring confirmed violations; sanitized claim/resolve/SLA tooling and the staffed-alert runbook are present. 599 isolated tests, 57 schema/tool checks, web/mobile types/lint, release/dependency/tooling contracts, a 94-route production build and desktop/phone Terms QC pass. It is not merged or hosted; OPS-04 rotation, live migration/acceptance, named/drilled monitoring and installed-native report/block/filter acceptance remain. B11h/#173 is merged and web/static legal/support pages are live. [Current handover](handovers/b11i-ugc-moderation-readiness.md).

**The next iOS candidate is locally ready for PR review, but cannot yet be submitted.** Expo SDK 57.0.24/RN 0.86.3, matching native template, generated privacy manifest and minimized permissions pass 597 isolated tests, 47 schema/tool checks, mobile contracts/types/lint/Doctor/audit, all-platform production-environment export and disposable iOS prebuild. EAS shows no production build/submission and cannot resolve the bundle with an available App Store Connect API key. No full Xcode/iOS simulator or Android emulator is installed; age-gate visuals were checked at desktop/phone widths, but deeper SDK 57 browser flows and native-device flows remain gated. [Current handover](handovers/b04h-b11g-ios-submission-readiness.md).
...
**#164 is released at `421f244`; #165 begins protected historical archival handling.** Final-primary score/edit/refresh/batch/retry and 48-wine scan flows pass at desktop/phone widths, including isolated bearer requests. AUD-11/28 are Closed; broader cache/version/profile work remains. New archival source `225c0ee` passes 568 isolated / 47 schema-tool checks, PostgreSQL catalog replay and four new real concurrency checks, lint and DB type contracts. All 189 eligible recovery receipts verify; nine unresolved originals remain held. #165 is unmerged and its migration is not hosted; no historical Storage copies/deletions occurred. [Current handover](handovers/b02y-release-archive.md), [archive runbook](b02y-protected-photo-archive.md).
