...
- **Latest release and resume point:** [B02r/B02s](handovers/b02r-b02s-release.md), [sanitized evidence](evidence/b02r-b02s-release.json). #152/#153 merged; owner-library API and mobile Library/Events adoption live-verified. Physical/direct/native rating privacy remains Partial.
...
**Next:** P0 AUD-01 supported-client/native rollout and durable legacy rekey/authority cutoff; QC-01 physical rating protection and remaining owner create/edit/import/server/operator consumers (feed, Home circle, detail/profile and mobile Library/Events adoption are released); AUD-13/15 atomic group and remaining lifecycle commands. AUD-06 public-profile writes/raw names and helper disclosures are repaired; native acceptance remains. QC-07/QC-17 retain Partial statuses for native acceptance/distribution. AUD-10 ai_notes_summary/OCR/scoring, AUD-09 deferred badge facts/history and AUD-19/21 bootstrap/adoption remain Partial. QC-18 unassociated web labels stays B11. AUD-49 is now Closed after B05f fresh-checkout and actual CI cleanup verification; original watcher acceptance and reopened history remain preserved. #81/#104/#112 stay open. Merge/close permission applied only to the completed session and expires at handoff.
