...
- **Current implementation checkpoint:** [B06d event navigation](handovers/batch-06d.md), following [B06c summary counts](handovers/batch-06c.md) and [B06b badge contracts](handovers/batch-06b.md), issue #112; final combined release in progress.
- **Latest handover and release:** [B05d/B06a merged and live-verified](handovers/b05d-b06a-release.md), [combined QC](../audits/b05d-b06a-qc-2026-09-13.md). Prior [B05b/B05c release](handovers/b05b-b05c-release.md). [Schema/replay](handovers/batch-05b.md), [type adoption](handovers/batch-05c.md), [combined QC](../audits/b05b-b05c-qc-2026-09-13.md). Prior releases: [B04d/B05a](handovers/b04d-b05a-release.md), [B04c](handovers/b04c-release.md), [B04a/B04b](handovers/b04-release.md), [B03](handovers/b03-release.md), [B02b](handovers/sql-rollout-b02b.md), [B01/B02a](handovers/sql-rollout-b01-b02a.md).
...
**B05d and B06a are merged; web is live-verified at `d4e5cd2` through PRs #108/#110.** Primary Vercel `dpl_32qQaMVqVsFmAffYh6nCLkiv35kP` is Ready on cellarsnap.app. B05d closes QC-13's server auth defect and extends AUD-21 with typed request cookie/bearer clients. B06a repairs the web Library date shift and shares the calendar-day formatter with mobile list/detail. [Release and resume steps](handovers/b05d-b06a-release.md).

**279 isolated checks**, five schema/source tests, database compile contracts, whole web/mobile types/lint, Next build and all Expo exports passed. Hands-on desktop/phone web and rebuilt Expo search/selection/date flows passed; Expo API cookies were stripped to prove bearer auth. Final production fresh login, phone autocomplete, desktop/phone Library, entry detail, sign-out and cookie/bearer HTTP parity passed. No SQL or intentional persistent data mutations. QC-02 stays **Partial** for native runtime/distribution; issue #109 remains open. Expo web is not native acceptance.

**Next: B06b / AUD-09 badge trigger and authority contracts**, then bounded QC-03 count definitions and QC-08 selected-slide navigation. Newly recorded **QC-14 / B05e** needs a reviewed forward repair of damaged historical grape alias keys (uppercase letters were removed before lowercasing); keep it separate from badge/date work and do not replay historical migrations. Broader AUD-21 query adoption and AUD-19 managed bootstrap/reviewed corpus restoration stay Partial under #104. B05b baseline/replay and B05c generated types remain released; no baseline SQL should run against production. AUD-20 fallback/native retirement prerequisites remain open. The merge permission was one-session only.
