...
- **Latest handover:** [B02b2 Storage/share privacy](handovers/batch-02b2.md). Predecessor: [B02b1 photo/group privacy](handovers/batch-02b1.md). Prior release: [B01/B02a SQL deployed](handovers/sql-rollout-b01-b02a.md); earlier [merged](handovers/merged-b01-b02a.md), [merge readiness](handovers/merge-readiness.md), [batch 02a](handovers/batch-02a.md) and [batch 01](handovers/batch-01.md).
...
B02b2 is implemented in [PR #87](https://github.com/Bobanski/CellarSnap/pull/87), stacked on [B02b1 PR #86](https://github.com/Bobanski/CellarSnap/pull/86). Storage authorization follows the source entry and current photo metadata, preserving reclassified photos, legacy/slide-only group images, originals, avatars, covers and independent copies. Anonymous shares now gate every candidate, deny test-authored/private sources, check revocation on each request and issue one-hour image URLs. **Neither B02b1 nor B02b2 migration is deployed.** AUD-01 remains Partial until release and hosted acceptance. [Contract](b02b2-storage-contract.md), [QC evidence](../audits/b02b2-storage-share-qc-2026-09-12.md).

At B02b2 implementation `eb52b33`, 196 automated tests, 148 actual isolated Supabase Storage HTTP checks, web/mobile lint/types, Next build and Expo export passed. Hands-on desktop/phone share privacy and navigation passed; Expo web retained owner three-image and non-owner two-image galleries plus private-entry denial on disposable live fixtures. Live fixture counts were restored. No native runtime is installed; hosted transformations/CDN and native gestures remain unverified. Web/mobile CI and the primary preview passed for implementation `eb52b33`; the duplicate Vercel failure remains OPS-01. Recheck final documentation head when resuming.

B01 [PR #80](https://github.com/Bobanski/CellarSnap/pull/80) and B02a [PR #82](https://github.com/Bobanski/CellarSnap/pull/82) remain merged, deployed and verified live. AUD-02/03 are Closed. Their SQL versions are `20260912211719` and `20260912211747`; exact reviewed-file checksums and rollout evidence are in the [prior handover](handovers/sql-rollout-b01-b02a.md). Do not reapply to reconcile timestamps. Primary production deployment succeeded previously; duplicate Vercel `cellarsnap` remains OPS-01. Coordinate the B02b1/B02b2 release; prioritize urgent AUD-04/B03 personal knowledge isolation next, with public identity/ratings (AUD-06/QC-01) as a separate B02 follow-up.
