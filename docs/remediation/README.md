...
- **Latest work checkpoint:** [B06f summary-outage QC](handovers/batch-06f.md). B06e #117 merged; B06f browser outage/empty/recovery checks pass, release pending. B05e aliases next.
...
**B06e #117 merged** as `65a4c1c`, primary production deployment Ready; authority SQL and hosted QC passed. **B06f QC-03 outage routing repaired**, desktop/phone failure, known-zero and recovery flows pass; release pending. [Current handover](handovers/batch-06f.md). QC-15 did not reproduce, QC-16 separately tracks absent Expo feature controls. Next B05e/QC-14.
