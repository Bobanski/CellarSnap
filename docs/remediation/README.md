...
**Next: bounded AUD-08 router-decoder compatibility repair**, followed by deliberate xcode/uuid tooling resolution and actual native QC/rebuilt client distribution when available. B05 remains the next broad schema/tooling batch. OPS-01 duplicate hosting, AUD-01 photo cache revocation/old-client acceptance and AUD-06/QC-01 public projections stay separate.
