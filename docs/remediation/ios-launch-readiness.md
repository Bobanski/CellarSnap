...
| UGC review readiness | QC-25 Partial: B11i locally adds database-authoritative shared-text/comment screening, canonical report intake, durable private evidence, four-/24-hour deadlines, a bounded operator tool and SLA alert contract. Deploy/live-test after OPS-04 rotation, name/drill the primary and backup alert/inbox owners, and pass installed-iOS report/block/filter acceptance before submission under App Review Guideline 1.2. See the [moderation runbook](../MODERATION_RUNBOOK.md). |
