...
- Privacy candidate: #167/#168 are merged; main `2205a5c` includes account-wide AI permission and shared disclosures. Matching backend/web deployed and production desktop/phone web + Expo-browser checks passed. Build final main for native distribution. ExifReader 4.41.1 patches a fresh advisory. [Current handover](handovers/b04f-b04g-ios-privacy.md).
...
| Privacy disclosures | QC-22 Partial: #168 adds shared accurate policy and explicit AI Allow/Decline/Revoke, enforced server-side. Production desktop/phone web/Expo-browser consent acceptance passes. Finish provider retention/contact/logging/native EXIF checks and enter/verify App Store Connect answers. Installed-native policy/permission acceptance remains required. |
