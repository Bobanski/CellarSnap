...
| Privacy disclosures | QC-22: web/mobile policy still names only OpenAI and signed URLs despite Anthropic/Google Vision and request-authorized delivery. Reconcile actual processing, retention/deletion and App Privacy selections before submission; verify any required third-party AI consent against actual UI. |
