...
| QC-03 | P2 | Profile/menu country and friend counts disagree | Implemented — QC pending | B06c: shared own-summary implemented; six isolated contracts, web/mobile types/lint and local cookie/bearer/browser count parity pass. Combined Expo/release pending. [Handover](handovers/batch-06c.md), issue #112. Broader top/average statistics and session ownership remain AUD-35/39. |
