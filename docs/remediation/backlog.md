...
| AUD-09 | P1 | Badge trigger/evaluator incompatibility and award authority | Partial | B06b #113 merged/live: 53 stored-fact definitions supported, 32 explicitly deferred; server-only award writes deployed and verified. [Release](handovers/b06b-b06d-release.md), [contract](b06-badge-contract.md), issue #112. B06e featured-profile authority implemented in draft #117, automated checks pass; SQL/browser QC/release pending. Remaining deferred facts/semantics, historical review and native acceptance. Preserve all 85 definitions. |
...
| QC-03 | P2 | Profile/menu country and friend counts disagree | Partial | B06c #114 merged/live: shared complete own-summary, cookie/bearer and desktop/phone/Expo count parity passed. [Release](handovers/b06b-b06d-release.md), issue #112. Native runtime/distribution and browser summary-outage visual acceptance remain; broader average/top statistics and session ownership stay AUD-35/39. |
...
| QC-15 | P2 | Transient local profile JSON parse failure | Needs triage | B06e QC intake: one dev /profile 500 followed by 200s, source unknown; reproduce before browser acceptance. See detail below. |
