...
|---|---|---|---|---|
| QC-01 | P1 | Mobile public feed displays raw numeric ratings | Partial | B02c1 #121 qualitative presentation QC passed; source release/native distribution pending. Direct feed/Data API rating payloads remain open. B02: enforce the intended qualitative public presentation and review public payloads; preserve owner's private 1–100 input. Related AUD-01/06/44. |
...
| QC-16 | P2 | Expo featured-badge handler has no reachable UI control | QC passed — release pending | B06g #122 desktop/phone Expo failure/recovery and persistence pass; native runtime/distribution remains pending. B06g / AUD-09; bearer legacy authority passes but no client feature/clear interaction exists. See detail below. |
