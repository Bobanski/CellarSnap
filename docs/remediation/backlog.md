...
| AUD-04 | P0 | Personal embeddings globally readable/searchable | In progress | B03a read containment on `codex/b03a-knowledge-isolation`, [issue #89](https://github.com/Bobanski/CellarSnap/issues/89). [PR #90](https://github.com/Bobanski/CellarSnap/pull/90): 201 tests, browser/Expo and 13 live read assertions passed; SQL deployed, merge pending. B03b lifecycle/FK and stale-generation rejection remain. [Handover](handovers/batch-03a.md). |
