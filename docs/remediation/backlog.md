...
| AUD-13 | P1 | Web/native entry lifecycle diverges | In progress | B08b atomic mobile detail/grape edits implemented on `codex/b08b-atomic-mobile-edits`; isolated failure/retry/concurrency pass, hosted/browser/native release pending. [Checkpoint](handovers/batch-08b.md). B08: authoritative command/side-effect contract covering consumed/cellared/shared/group entries; parity across clients while preserving drafts and native I/O. |
