...
| QC-17 | P1 | Mobile owner editor cannot search/add grapes | In progress | B08a: actual notes-only/explicit-grape QC found search gated on bulk review. Enable it during normal owner editing and verify search/add/save/reload. |
