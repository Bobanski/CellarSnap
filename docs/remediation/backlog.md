...
**Latest release:** B02g/B02h/B08c merged through `ae6f354`; both forward SQL files are live and full-catalog verified. [Current handover](handovers/b02g-b02h-b08c-release.md) records 411 isolated / 18 schema checks, actual desktop/phone web/Expo and live QC, remaining P0 privacy/lifecycle work and unavailable native acceptance. B02h is a measured contract, not a production rekey.
...
|---|---|---|---|---|
| QC-01 | P1 | Mobile public feed displays raw numeric ratings | Partial | B02c1 #121 merged `6c28498`: shared enjoyment bands replace numeric labels for ordinary/grouped mobile feed, desktop/phone Expo QC passed. Owner 1–100 inputs retained. Direct feed/Data API payload rating privacy and native distribution remain open; related AUD-01/06/44. [Release](handovers/b02c1-b06g-b07a-b06h-release.md). |
