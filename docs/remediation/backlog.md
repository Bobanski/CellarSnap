...
| AUD-48 | P1 | Regression baseline incomplete/untrustworthy | Partial | B02b1 expands to 189 tests plus 54 new isolated photo/group HTTP checks and desktop/phone/Expo QC ([report](../audits/b02b1-photo-group-qc-2026-09-12.md)); prior 56 app/database comparisons, 41 B01/B02a HTTP checks and build/browser QC remain; rollout adds 35 live HTTP/Storage checks, eight rolled-back SQL assertions and live web/Expo checks. [Evidence](../audits/sql-rollout-qc-2026-09-12.md). Native and future lifecycle/import/cache/scoring coverage remain batch obligations. |
