...
| AUD-09 | P1 | Badge trigger/evaluator incompatibility and award authority | Partial | B06b implementation/QC checkpoint: 53 stored-fact definitions supported, 32 explicitly deferred; server award writer and client privilege migration, not yet released. [Contract](b06-badge-contract.md), [handover](handovers/batch-06b.md), issue #112. Remaining featured-profile authority, deferred trigger facts, historical review and native acceptance. B06: exhaustive shared trigger union coverage, server-authoritative awards, checked writes, representative fixtures for all supported trigger families; preserve all 85 definitions. |
...
| QC-03 | P2 | Profile/menu country and friend counts disagree | QC passed — release pending | B06c: shared own-summary implemented; six isolated contracts, web/mobile types/lint and local cookie/bearer/browser count parity pass. Expo menu/profile/Library parity passed with cookies stripped; release/native pending. [Handover](handovers/batch-06c.md), issue #112. Broader top/average statistics and session ownership remain AUD-35/39. |
...
| QC-08 | P2 | Event card details link differs from selected wine slide | QC passed — release pending | B06d: shared stable slide selection and deliberate context behavior; web/Expo A/B/context navigation and restricted/reordered fixtures pass. [Handover](handovers/batch-06d.md), issue #112. Merge/deployment/live and native acceptance pending. |
