...
| AUD-06 | P0 | Public identity projection overexposes fields and permits writes | In progress | B02c2 on `codex/b02c2-public-profile-authority`: hosted catalog confirms authenticated mutation grants and updatable identity columns on a definer view over owner-only profiles. Contain writes and expose a preference-aware, viewer-filtered projection. Related QC-01; numeric entry payloads remain separate. |
