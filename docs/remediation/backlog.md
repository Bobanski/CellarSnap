...
| AUD-04 | P0 | Personal embeddings globally readable/searchable | In progress | B03a read containment on `codex/b03a-knowledge-isolation`, [issue #89](https://github.com/Bobanski/CellarSnap/issues/89). 201 automated tests pass; browser/release QC pending. B03b lifecycle/FK and stale-generation rejection remain. [Handover](handovers/batch-03a.md). |
