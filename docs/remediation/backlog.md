...
**Latest release:** B02e/B02f/B08b merged through `278bb11`; all three forward SQL files and primary web are live-verified. [Current handover](handovers/b02e-b02f-b08b-release.md) records 406 isolated / 16 schema checks, actual desktop/phone web/Expo QC, remaining privacy/lifecycle work and unavailable native acceptance.
...
|---|---|---|---|---|---|
| AUD-01 | P0 | Entry/photo policies bypass privacy | Partial | B02a/B02b entry, metadata/group and Storage repairs retain their [release history](handovers/sql-rollout-b02b.md). B02d #127 repaired new anonymous images. B02e #130 merged `685b953`: cookie-web image bytes recheck current access, no browser Storage signatures, crop preserved. Live desktop/phone same-URL privacy/test denial and restore passed. Remaining: bearer/native adoption and measured legacy SDK/signed/transformed cache revocation; no global revocation or native acceptance claim. [Current release](handovers/b02e-b02f-b08b-release.md). |
...
| AUD-13 | P1 | Web/native entry lifecycle diverges | Partial | B08b #132 merged `278bb11`, atomic detail/grape SQL live: normal/bulk mobile save uses one owner-checked transaction, raw expected state, no-op retry and 15-second deadline. Hosted QC found pending `40001` conflicts; forward `PT409` correction and desktop/phone conflict/failure/lost-response/timeout/bulk retests passed. Native runtime/distribution, web/group and broader consumed/cellared/shared lifecycle/side-effect parity remain B08. [Release](handovers/b02e-b02f-b08b-release.md). |
...
| AUD-15 | P1 | Multi-table mutations rely on compensation/positions | Partial | B08b #132 atomic mobile details/ordered grapes, rollback and concurrent/repeated retry with stable link IDs implemented and SQL live. Actual Expo normal/bulk failure/recovery passed; native distribution pending. B08 remainder: other lifecycle/import commands, stable request/row IDs and intentional partial-import reporting. [Release](handovers/b02e-b02f-b08b-release.md). |
