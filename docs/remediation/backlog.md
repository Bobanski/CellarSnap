...
| AUD-04 | P0 | Personal embeddings globally readable/searchable | Partial | B03a [PR #90](https://github.com/Bobanski/CellarSnap/pull/90) merged `19cb4fe`; SQL/read isolation live. B03b lifecycle implementation on `codex/b03b-knowledge-lifecycle`, [issue #89](https://github.com/Bobanski/CellarSnap/issues/89): [PR #91](https://github.com/Bobanski/CellarSnap/pull/91): 212 tests, 20 live HTTP assertions, concurrent transactions and phone/Expo current-note checks passed. Lifecycle SQL live and 386 vectors regenerated; batching follow-up/final release pending. [Handover](handovers/batch-03b.md). |
...
| AUD-26 | P2 | Retention and derived refresh metadata undefined | Partial | B03b adds personal snapshot publication and deletion/update invalidation; rollout pending. B03 personal-data cleanup; B10 full lifecycle: bounded retention, authoritative timestamps/versioning, incremental refresh and deletion propagation without losing raw provenance. |
