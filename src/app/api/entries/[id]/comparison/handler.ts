...
type ComparisonPostHandlerDependencies = {
  requireRequestAuth?: typeof requireRequestAuth;
};

export function createComparisonPostHandler(
  dependencies: ComparisonPostHandlerDependencies = {}
) {
  const requireAuth = dependencies.requireRequestAuth ?? requireRequestAuth;
