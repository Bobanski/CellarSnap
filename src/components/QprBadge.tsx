...
const QPR_STYLES: Record<QprLevel, string> = {
  extortion: "border-[rgba(196,96,122,0.4)] bg-[rgba(196,96,122,0.1)] text-[var(--color-accent-secondary)]",
  pricey: "border-[rgba(138,128,120,0.4)] bg-[rgba(138,128,120,0.1)] text-[var(--color-text-secondary)]",
  mid: "border-[rgba(201,168,76,0.4)] bg-[rgba(201,168,76,0.1)] text-[var(--color-accent-gold-text)]",
