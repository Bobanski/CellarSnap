  ...
  return (
    <div ref={containerRef} className="relative">
      ...
      {open && suggestions.length > 0 && (
        <div className="absolute left-0 right-0 top-full z-20 mt-1 max-h-64 overflow-y-auto rounded-xl border border-[var(--color-border)] bg-[var(--color-surface-raised)] p-1 shadow-xl">
          ...
          <div className="px-3 pb-1 pt-2 text-right text-[10px] text-[var(--color-text-tertiary)]">
            Powered by Google
          </div>
        </div>
      )}
