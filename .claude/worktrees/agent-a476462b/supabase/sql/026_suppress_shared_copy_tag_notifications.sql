-- Shared tastings can create a "tag me back" feedback loop:
-- If Alice tags Bob, then Bob adds a shared-tasting copy and tags Alice,
-- Alice should not get a redundant "tagged" notification.
