-- AUD-13 / B08b QC correction: expected optimistic conflicts are not database
-- serialization failures. PT409 promptly returns HTTP 409 through PostgREST.
-- Keep the already-deployed initial migration immutable.
begin;
