...
--
-- Name: objects Delete_own_photos bzgjph_0; Type: POLICY; Schema: storage; Owner: supabase_storage_admin
--

CREATE POLICY "Delete_own_photos bzgjph_0" ON storage.objects FOR DELETE TO authenticated USING (((bucket_id = 'wine-photos'::text) AND (split_part(name, '/'::text, 1) = (auth.uid())::text)));


--
-- Name: objects Public read access for public-assets; Type: POLICY; Schema: storage; Owner: supabase_storage_admin
--

CREATE POLICY "Public read access for public-assets" ON storage.objects FOR SELECT USING ((bucket_id = 'public-assets'::text));


--
-- Name: objects Update_Own_Photos bzgjph_0; Type: POLICY; Schema: storage; Owner: supabase_storage_admin
--

CREATE POLICY "Update_Own_Photos bzgjph_0" ON storage.objects FOR UPDATE TO authenticated USING (((bucket_id = 'wine-photos'::text) AND (split_part(name, '/'::text, 1) = (auth.uid())::text)));


--
-- Name: objects Upload_Own_Photos bzgjph_0; Type: POLICY; Schema: storage; Owner: supabase_storage_admin
--

CREATE POLICY "Upload_Own_Photos bzgjph_0" ON storage.objects FOR INSERT TO authenticated WITH CHECK (((bucket_id = 'wine-photos'::text) AND (split_part(name, '/'::text, 1) = (auth.uid())::text)));


--
-- Name: objects Users can read allowed wine photos; Type: POLICY; Schema: storage; Owner: supabase_storage_admin
--

CREATE POLICY "Users can read allowed wine photos" ON storage.objects FOR SELECT TO authenticated USING (((bucket_id = 'wine-photos'::text) AND public.can_access_wine_photo(name)));
